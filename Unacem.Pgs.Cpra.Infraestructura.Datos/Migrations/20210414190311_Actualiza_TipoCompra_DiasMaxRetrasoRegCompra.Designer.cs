...
namespace Unacem.Pgs.Cpra.Infraestructura.Datos.Migrations
{
    ...
    [Migration("20210414190311_Actualiza_TipoCompra_DiasMaxRetrasoRegCompra")]
    partial class Actualiza_TipoCompra_DiasMaxRetrasoRegCompra
    {
            ...
            modelBuilder.Entity("Unacem.Pgs.Cpra.AplicacionCore.Agregados.Compras.Compra", b =>
                {
                    ...
                    b.HasIndex("CodigoLocalProgresolSap");
            ...
            modelBuilder.Entity("Unacem.Pgs.Cpra.AplicacionCore.Agregados.Compras.TipoCompra", b =>
                {
                    ...
                    b.Property<int>("DiasRetrasoMaximoRegistroCompra")
                        .HasColumnType("int")
                        .HasColumnName("NUM_DIAS_RETRASO_REGISTRO");
            ...
            modelBuilder.Entity("Unacem.Pgs.Cpra.AplicacionCore.Agregados.Compras.Compra", b =>
                {
                    b.HasOne("Unacem.Pgs.Cpra.AplicacionCore.Agregados.Compras.Progresol", null)
                        .WithMany()
                        .HasForeignKey("CodigoLocalProgresolSap")
                        .HasConstraintName("FK_PGSTB_COMPRA_MINORISTA_PGSTB_TEMP_FUN_CLIENTESPS_SAP_X_LOCAL")
                    ...
                    b.HasOne("Unacem.Pgs.Cpra.AplicacionCore.Agregados.Compras.TipoCompra", "TipoCompra")
                        .WithMany()
            ...
            modelBuilder.Entity("Unacem.Pgs.Cpra.AplicacionCore.Agregados.Cuotas.CuotaProgresol", b =>
                {
                    b.HasOne("Unacem.Pgs.Cpra.AplicacionCore.Agregados.Compras.Progresol", "Progresol")
                        .WithMany()
                        .HasForeignKey("CodigoLocalProgresolSap")
                        .HasConstraintName("FK_PGSTB_CUOTA_LOCAL_PGSTB_PROGRESOL_X_LOCAL")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
